        ...
        <div className="col-sm-12 col-md-6 col-lg-4 p-0">
            <div className="gameWrapper">
                <div className="scoreWrapper pb-3">
                    <div className={`teamWrapper ${Number(game.score_home) > Number(game.score_away) && "fw-semibold"}`}>
                    ...
                    <div className={`teamWrapper ${Number(game.score_away) > Number(game.score_home) && "fw-semibold"}`}>
